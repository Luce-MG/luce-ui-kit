...
export declare type CustomVariant = 'primary' | 'secondary' | 'officeCleaning' | 'homeCleaning' | 'percentage' | 'hourlyRate' | 'casual' | 'error' | 'assigned' | 'changed' | 'unassigned' | 'replaced';
