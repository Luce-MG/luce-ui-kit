...
var FormTimePicker = function (props) {
    ...
    return (React.createElement(react_hook_form_1.Controller, { control: control, name: name, defaultValue: defaultValue !== null && defaultValue !== void 0 ? defaultValue : null, render: function (_a) {
            ...
            return (React.createElement(Pickers_1.KeyboardTimePicker, __assign({ autoOk: true, value: value, label: label ? label : undefined, inputProps: { 'data-testid': name }, minutesStep: 5 }, rest, { onChange: onChange, fullWidth: true, variant: "inline", InputAdornmentProps: { position: 'end' }, helperText: (_b = errors["" + name]) === null || _b === void 0 ? void 0 : _b.message, error: !!errors["" + name], FormHelperTextProps: formHelperTextProps, className: classes.root })));
        } }));
};
